...
def _read_projection_inputs(
    ...
    Args:
        ...
        lines: Optional axis-aligned pattern segments. Non-empty input must
    ...
    Raises:
        ...
        ValueError: If mesh arrays, scalars, pattern lines, or coordinates are
            invalid.
...
def _to_circle(
    ...
    Args:
        ...
        radius: Positive target-circle radius.
        node_indices: Ordered source-boundary node indices.
        lines: Optional finite horizontal or vertical pattern segments.
