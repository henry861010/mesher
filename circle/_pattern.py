...
def _subdivisions_for_gap(
    ...
    *,
    ...
    Args:
        ...
        radius: Pattern-circle radius.
        element_size: Maximum allowed arc length.
...
class _PatternCircleInputs(NamedTuple):
    ...
    Attributes:
        ...
        center: Pattern-circle center.
        radius: Pattern-circle radius.
        element_size: Maximum requested arc length.
...
def _read_pattern_circle_inputs(
    ...
    Args:
        ...
        element_size: Positive maximum arc length.
        lines: Optional finite axis-aligned pattern segments.

    Returns:
        Validated node array, center, scalar values, and pattern lines.

    Raises:
        TypeError: If mesh is not a Mesh instance.
        ValueError: If nodes, scalars, or pattern lines are invalid.
    """
...
def _sample_pattern_circle(
    ...
    *,
    ...
    Args:
        ...
        center: Pattern-circle center.
        radius: Pattern-circle radius.
        element_size: Maximum arc length.
...
def _generate_pattern_circle_nodes(
    ...
    Args:
        ...
        center_y: Y coordinate of the pattern-circle center.
        radius: Positive pattern-circle radius.
        element_size: Positive maximum arc length between adjacent nodes.
    ...
    nodes, center, radius, element_size, pattern_lines = inputs
